...
namespace MPL::RegionRuntime
{
    ...
    inline std::string EditorID(API::MMSF::ServiceMap* a_api, RE::TESRegion* a_region)
    {
    ...
    inline std::string GetRegion(API::MMSF::ServiceMap* a_api, RE::TESObjectCELL* a_cell)
    {
        if (!a_api) return {};
